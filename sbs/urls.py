...
urlpatterns = [
    ...
    path('yeka/ilerleme-rapor-ekle/<uuid:comp_uuid>', YekaBussinessBlogStaticView.add_progressreport,
    ...
    path(r'hakem-duzenle/<uuid:uuid>', RefereeViews.update_referee, name='update_referee'),
    path(r'hakem/hakemler/sil/', RefereeViews.delete_referee, name='delete-referee'),
    path(r'hakem/hakem-kademe-ekle/<uuid:uuid>', RefereeViews.add_grade_referee, name='add_grade_referee'),
    path(r'hakem/hakem-kademe-duzenle/onayla/<uuid:grade_uuid>/<uuid:referee_uuid>$', RefereeViews.grade_approval,
         name='grade_approval'),
    path(r'hakem/hakem-kademe-duzenle/reddet/<uuid:grade_uuid>/<uuid:referee_uuid>$', RefereeViews.grade_reject,
         name='grade_reject'),
    path(r'hakem/hakem-kademe-duzenle/guncelle/<uuid:grade_uuid>/<uuid:referee_uuid>$', RefereeViews.update_grade,
         name='update_grade'),
    path(r'hakem/hakem-kademe-duzenle/sil/', RefereeViews.delete_grade, name='delete_grade'),
    path(r'hakem/hakem-vize-ekle/<uuid:uuid>', RefereeViews.add_visa_referee, name='add_visa_referee'),
    path(r'hakem/hakem-vize-duzenle/onayla/<uuid:visa_uuid>/<uuid:referee_uuid>$', RefereeViews.visa_approval,
         name='visa_approval'),
    path(r'hakem/hakem-vize-duzenle/reddet/reddet/<uuid:referee_uuid>$', RefereeViews.visa_reject,
         name='visa_reject'),
    path(r'hakem/hakem-vize-duzenle/guncelle/<uuid:visa_uuid>/<uuid:referee_uuid>$', RefereeViews.visa_update,
         name='update_visa'),
    path(r'hakem/hakem-vize-duzenle/sil/', RefereeViews.visa_delete, name='delete_visa'),

    path(r'hakem/seviye/', RefereeViews.return_level, name='return_levels'),
    path(r'hakem/seviye/guncelle/<uuid:uuid>', RefereeViews.levelUpdate, name='update_level'),
    path(r'hakem/seviye/sil/', RefereeViews.levelDelete, name='delete_level'),
    path(r'hakem/kademe-listesi/', RefereeViews.gradeList, name='grade_list'),
    path(r'hakem/kademe-listesi/onayla/<uuid:uuid>$', RefereeViews.gradeListApproval,
         name='grade_list_approval'),
    path(r'hakem/kademe-listesi/reddet/<uuid:uuid>$', RefereeViews.gradeListReject, name='grade_list_reject'),
    path(r'hakem/kademe-listesi-onayla-hepsi$', RefereeViews.gradeListApprovalAll,
         name='grade-list-approval-all'),
    path(r'hakem/kademe-listesi-reddet-hepsi$', RefereeViews.gradeListRejectAll,
         name='grade-list-reject-all'),
    path(r'hakem/vize-listesi/', RefereeViews.visaList, name='visa_list'),
    path(r'hakem/vize-listesi/onayla/<uuid:uuid>$', RefereeViews.visaListApproval,
    ...
    path(r'hakem/visa-seminar-ekle$', RefereeViews.addVisaSeminar, name='add-visa-seminar-referee'),
    path(r'hakem/visa-seminar-duzenle/<uuid:uuid>$', RefereeViews.updateVisaSeminar, name='update-visa-seminar'),
    path(r'hakem/visa-seminar-onayla/<uuid:uuid>$', RefereeViews.visaSeminarApproval,
         name='referee-visa-seminar-approval'),
    path(r'hakem/visa-seminar/hakem-sec/<uuid:uuid>$', RefereeViews.addRefereeVisaSeminar,
         name='add-referee-visa-seminar'),
    path(r'hakem/visa-seminar/hakem-kaldir/', RefereeViews.deleteRefereeVisaSeminar,
         name='delete-referee-visa-seminar'),
    path(r'hakem/visa-Seminar/seminer-sil/', RefereeViews.deleteVisaSeminar, name='delete-visa-seminar'),
    path(r'hakem/visa-seminar/basvuru-listesi$', RefereeViews.returnVisaSeminarApplication,
         name='return-visa-seminar-application'),
    path(r'hakem/visa-Seminar/hakem-basvuru-reddet/',
         RefereeViews.deleteRefereeApplicationVisaSeminar, name='delete-referee-application-visa-seminar'),
    path(r'hakem/visa-Seminar/hakem-basvuru-onayla/',
         RefereeViews.approvalRefereeApplicationVisaSeminar, name='approval-referee-application-visa-seminar'),

    path(r'hakem/belge/<uuid:uuid>$', RefereeViews.document, name='document-referee'),
    ...
    path(r'antrenor-duzenle/<uuid:uuid>', CoachViews.coachUpdate, name='update_coach'),
    path(r'antrenor/antrenorler/sil/', CoachViews.delete_coach, name='delete-coach'),
    path(r'antrenor/antrenor-kademe-ekle/<uuid:uuid>', CoachViews.add_coach_referee, name='add_grade_coach'),
    path(r'antrenor/antrenor-kademe-duzenle/onayla/<uuid:grade_uuid>/<uuid:coach_uuid>$', CoachViews.grade_approval,
         name='coach_grade_approval'),
    path(r'antrenor/antrenor-kademe-duzenle/reddet/<uuid:grade_uuid>/<uuid:coach_uuid>$', CoachViews.grade_reject,
         name='coach_grade_reject'),
    path(r'antrenor/antrenor-kademe-duzenle/guncelle/<uuid:grade_uuid>/<uuid:coach_uuid>$', CoachViews.update_grade,
         name='coach_update_grade'),
    path(r'antrenor/antrenor-kademe-duzenle/sil/', CoachViews.delete_grade, name='coach_delete_grade'),
    path(r'antrenor/antrenor-vize-ekle/<uuid:uuid>', CoachViews.add_visa_coach, name='add_visa_coach'),
    path(r'antrenor/antrenor-vize-duzenle/onayla/<uuid:visa_uuid>/<uuid:coach_uuid>$', CoachViews.visa_approval,
         name='coach_visa_approval'),
    path(r'antrenor/antrenor-vize-duzenle/reddet/reddet/<uuid:visa_uuid>/<uuid:coach_uuid>$', CoachViews.visa_reject,
         name='coach_visa_reject'),
    path(r'antrenor/antrenor-vize-duzenle/guncelle/<uuid:visa_uuid>/<uuid:coach_uuid>$', CoachViews.visa_update,
         name='coach_update_visa'),
    path(r'antrenor/antrenor-vize-duzenle/sil/', CoachViews.visa_delete, name='coach_delete_visa'),

    path(r'antrenor/kademe/', CoachViews.return_grade, name='return_grade'),
    path(r'antrenor/kademe/guncelle/<uuid:uuid>', CoachViews.gradeUpdate, name='update_grades'),
    path(r'antrenor/kademe/sil/', CoachViews.gradeDelete, name='delete_grades'),
    path(r'antrenor/kademe-listesi/', CoachViews.gradeList, name='coach_grade_list'),
    path(r'antrenor/kademe-listesi/onayla/<uuid:uuid>$', CoachViews.gradeListApproval,
         name='coach_grade_list_approval'),
    path(r'antrenor/kademe-listesi/reddet/<uuid:uuid>$', CoachViews.gradeListReject, name='coach_grade_list_reject'),
    path(r'antrenor/kademe-listesi-onayla-hepsi$', CoachViews.gradeListApprovalAll,
         name='coach_grade-list-approval-all'),
    path(r'antrenor/kademe-listesi-reddet-hepsi$', CoachViews.gradeListRejectAll,
         name='coach_grade-list-reject-all'),
    path(r'antrenor/vize-listesi/', CoachViews.visaList, name='coach_visa_list'),
    path(r'antrenor/vize-listesi/onayla/<uuid:uuid>$', CoachViews.visaListApproval,
         name='coach_visa_list_approval'),
    path(r'antrenor/vize-listesi/reddet/<uuid:uuid>$', CoachViews.visaListReject, name='coach_visa_list_reject'),

    # Antrenör VİZE SEMİNER

    path(r'antrenor/visa-seminar$', CoachViews.returnVisaSeminar, name='coach-visa-seminar'),
    path(r'antrenor/visa-seminar/basvuru-listesi$', CoachViews.returnVisaSeminarApplication,
         name='return-coach-visa-seminar-application'),
    path(r'antrenor/visa-seminar-ekle$', CoachViews.addVisaSeminar, name='add-visa-seminar-coach'),
    path(r'antrenor/visa-seminar-duzenle/<uuid:uuid>$', CoachViews.updateVisaSeminar, name='update-coach-visa-seminar'),
    path(r'antrenor/visa-Seminar/seminer-sil/', CoachViews.deleteVisaSeminar, name='delete-coach-visa-seminar'),
    path(r'antrenor/visa-seminar-onayla/<uuid:uuid>$', CoachViews.visaSeminarApproval,
         name='coach-visa-seminar-approval'),
    path(r'antrenor/visa-seminar/antrenor-sec/<uuid:uuid>$', CoachViews.addCoachVisaSeminar,
         name='add-coach-visa-seminar'),
    path(r'antrenor/visa-seminar/antrenor-kaldir/', CoachViews.deleteCoachVisaSeminar,
         name='delete-coach-visa-seminar'),
    path(r'antrenor/visa-Seminar/antrenor-basvuru-reddet/',
         CoachViews.deleteCoachApplicationVisaSeminar, name='delete-coach-application-visa-seminar'),
    path(r'antrenor/visa-Seminar/antrenor-basvuru-onayla/',
