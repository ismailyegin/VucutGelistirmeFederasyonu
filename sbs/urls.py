...
urlpatterns = [
    ...
    path(r'hakem/hakem-kademe-onayla/<uuid:grade_uuid>/<uuid:referee_uuid>', RefereeViews.grade_approval,
         name='grade_approval'),
    path(r'hakem/hakem-kademe-/reddet/<uuid:grade_uuid>/<uuid:referee_uuid>', RefereeViews.grade_reject,
         name='grade_reject'),
    path(r'hakem/hakem-kademe-duzenle/<uuid:grade_uuid>/<uuid:referee_uuid>', RefereeViews.update_grade,
         name='update_grade'),
    ...
    path(r'hakem/hakem-vize-onayla/<uuid:visa_uuid>/<uuid:referee_uuid>', RefereeViews.visa_approval,
         name='visa_approval'),
    path(r'hakem/hakem-vize-reddet/<uuid:visa_uuid>/<uuid:referee_uuid>', RefereeViews.visa_reject,
         name='visa_reject'),
    path(r'hakem/hakem-vize-guncelle/<uuid:visa_uuid>/<uuid:referee_uuid>', RefereeViews.visa_update,
         name='update_visa'),
    ...
    path(r'antrenor/antrenor-kademe-onayla/<uuid:grade_uuid>/<uuid:coach_uuid>', CoachViews.grade_approval,
         name='coach_grade_approval'),
    path(r'antrenor/antrenor-kademe-reddet/<uuid:grade_uuid>/<uuid:coach_uuid>', CoachViews.grade_reject,
         name='coach_grade_reject'),
    path(r'antrenor/antrenor-kademe-guncelle/<uuid:grade_uuid>/<uuid:coach_uuid>', CoachViews.update_grade,
         name='coach_update_grade'),
    path(r'antrenor/antrenor-kademe-sil/', CoachViews.delete_grade, name='coach_delete_grade'),
    path(r'antrenor/antrenor-vize-ekle/<uuid:uuid>', CoachViews.add_visa_coach, name='add_visa_coach'),
    path(r'antrenor/antrenor-vize-onayla/<uuid:visa_uuid>/<uuid:coach_uuid>', CoachViews.visa_approval,
         name='coach_visa_approval'),
    path(r'antrenor/antrenor-vize-reddet/<uuid:visa_uuid>/<uuid:coach_uuid>', CoachViews.visa_reject,
         name='coach_visa_reject'),
    path(r'antrenor/antrenor-vize-guncelle/<uuid:visa_uuid>/<uuid:coach_uuid>', CoachViews.visa_update,
