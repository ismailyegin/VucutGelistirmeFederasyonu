...
from sbs.services.services import BusinessBlogGetService
...
class CompetitionBusinessBlockForm(ModelForm):
    class Meta:
    ...
    def __init__(self, business, yekabussiness, *args, **kwargs):
        super(CompetitionBusinessBlockForm, self).__init__(*args, **kwargs)
