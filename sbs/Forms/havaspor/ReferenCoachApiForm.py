...
class RefereeCoachApiForm(ModelForm):
    class Meta:
        ...
        labels = {'iban': 'İban Adresi', 'first_name': 'Ad', 'last_name': 'Soyad', 'email': 'Email',
                  ...
                  'kademe_belge': 'Sözleşme Belgesi: ',
                  'kademe_startDate': 'Kademe Başlangıç Zamanı ', 'sgk': 'SGK Belgesi: ', 'dekont': 'Vize Dekont',
                  'belge': 'Antrenör Belgesi'}
        widgets = {
