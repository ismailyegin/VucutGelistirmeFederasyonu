# Generated by Django 3.2.6 on 2022-03-07 11:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificationDate', models.DateTimeField(auto_now=True, null=True)),
                ('kobilid', models.IntegerField(blank=True, default=1, null=True)),
                ('statusChangeDate', models.DateField(auto_now_add=True, null=True)),
                ...
                ('status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sbs.status')),
                ('statusChangeUser', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificationDate', models.DateTimeField(auto_now=True, null=True)),
                ('kobilid', models.IntegerField(blank=True, default=1, null=True)),
                ('nufusCuzdani', models.FileField(blank=True, max_length=500, null=True, upload_to='', verbose_name='Nufüs Cüzdanı')),
                ('diploma', models.FileField(blank=True, max_length=500, null=True, upload_to='', verbose_name='Diploma')),
                ('sabikaKaydi', models.FileField(blank=True, max_length=500, null=True, upload_to='', verbose_name='Sabıka Kaydı')),
                ('cezaYazisi', models.FileField(blank=True, max_length=500, null=True, upload_to='', verbose_name='Ceza Yazısı')),
                ('saglikBeyanFormu', models.FileField(blank=True, max_length=500, null=True, upload_to='', verbose_name='Sağlık Beyan Formu')),
                ('hakemBilgiFormu', models.FileField(blank=True, max_length=500, null=True, upload_to='', verbose_name='Hakem Bilgi Formu')),
                ...
                ('communication', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sbs.communication')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sbs.person')),
                ('status', models.ManyToManyField(to='sbs.RefereeStatus')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='sbs.categoryitem')),
            ],
            options={
                'abstract': False,
            },
