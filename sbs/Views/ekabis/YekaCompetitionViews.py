...
from sbs.Forms.CompetitionBusinessBlockForm import CompetitionBusinessBlockForm
from sbs.Forms.PurchaseGuaranteeForm import PurchaseGuaranteeForm
from sbs.Forms.YekaBusinessForm import YekaBusinessForm
from sbs.Forms.YekaCompetitionForm import YekaCompetitionForm
...
from sbs.models.ekabis.YekaPurchaseGuarantee import YekaPurchaseGuarantee
...
from sbs.services.services import YekaGetService, ConnectionRegionGetService, YekaCompetitionGetService, \
...
def view_competition_yekabusinessBlog(request, uuid):
    ...
    try:
        ...
        if url and url != 'view_competitionbusinessblog':
            return redirect('sbs:' + url, competition.uuid)
