...
from sbs.Forms.YekaBusinessBlogForm import YekaBusinessBlogForm
from sbs.Forms.YekaForm import YekaForm
from sbs.Forms.YekaHoldingCompetitionForm import YekaHoldingCompetitionForm
from sbs.Views.ekabis.VacationDayViews import is_vacation_day
...
from sbs.models.ekabis.FileExtension import FileExtension
...
from sbs.models.ekabis.YekaHoldingCompetition import YekaHoldingCompetition
from sbs.models.ekabis.YekaPerson import YekaPerson
from sbs.models.ekabis.YekaPersonHistory import YekaPersonHistory
from sbs.models.ekabis.YekaProposal import YekaProposal
from sbs.serializers.CompanySerializers import CompanySerializer
from sbs.serializers.CompetitionSerializers import YekaCompetitionSerializer
from sbs.serializers.ConnectionRegionSerializer import ConnectionRegionSerializer
from sbs.serializers.YekaCompanySerializers import YekaCompanySerializer
from sbs.serializers.YekaCompetitionEskalasyonSerializers import YekaCompetitionEskalasyonSerializer
from sbs.serializers.YekaProposalSerializers import ProposalSerializer
from sbs.serializers.YekaSerializer import YekaSerializer
from sbs.services import general_methods
from sbs.services.NotificationServices import notification
from sbs.services.general_methods import get_error_messages, get_client_ip
from sbs.services.services import YekaService, YekaConnectionRegionService, YekaGetService, \
    YekaPersonService, \
...
def alt_yeka_ekle(request, uuid):
    ...
    #     if url:
    #         return redirect('sbs:' + url, yeka.uuid)
    #
    #     alt_yeka_filter = {
    #         'yekaParent': yeka,
    #         'isDeleted': False
...
def update_sub_yeka(request, uuid):
    ...
    #     traceback.print_exc()
    #     messages.warning(request, 'Lütfen Tekrar Deneyiniz.')
    #     return redirect('sbs:change_sub_yeka', uuid)
    return
...
#                         log = general_methods.logwrite(request, request.user, log)
#         return redirect('sbs:view_yeka_company', yeka.uuid)
#
