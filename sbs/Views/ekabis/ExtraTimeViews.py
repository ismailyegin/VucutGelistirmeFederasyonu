...
from sbs.Forms.ExtraTimeFileForm import ExtraTimeFileForm
from sbs.Forms.ExtraTimeForm import ExtraTimeForm
...
from sbs.services.services import ExtraTimeService, ExtraTimeGetService, ExtraTimeFileGetService, last_urls
...
def return_add_extra_time(request, business, businessblog):
    ...
    try:
        ...
        #      return redirect('sbs:change_extratime', ExtraTime.objects.get(yekabusinessblog=yekabussinessblog).uuid)
