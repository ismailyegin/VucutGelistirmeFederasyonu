...
from sbs.Forms.BusinessBlogForm import BusinessBlogForm
from sbs.Forms.BusinessBlogParametreForm import BusinessBlogParametreForm
...
from sbs.services.services import YekaBusinessGetService, last_urls
...
def add_yekabusiness(request, uuid):
    ...
    try:
        ...
        return redirect('sbs:view_yekabusiness')
